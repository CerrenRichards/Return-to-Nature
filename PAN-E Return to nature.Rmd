...
test <- test %>% group_by(country) %>% mutate(time = 1:n())
...
test$Luxury.pred <- unlist(lapply(countries, function(country) predict_lux[[country]]))


test$Luxury.pred.resid <- unlist(lapply(countries, function(country) predict_lux.resid[[country]]))

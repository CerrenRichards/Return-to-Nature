...
median(returns$Necessities_diff.resid, na.rm = T) # 129 days
median(returns$Necessities_diff.gam, na.rm = T) # 136 days
median(returns$Necessities_diff.resid.gam, na.rm = T) # 318 days

# NATURE
median(returns$nature_diff, na.rm = T) # 76 after peak lockdown
median(returns$nature_diff.resid, na.rm = T) # 129 days
median(returns$nature_diff.gam, na.rm = T) # 93 days
median(returns$nature_diff.resid.gam, na.rm = T) # 319 days

# LUXURY
median(returns$Luxury_diff, na.rm = T) # 153 after peak lockdown
median(returns$Luxury_diff.resid, na.rm = T) # 129 days
median(returns$Luxury_diff.gam, na.rm = T) # 408 days
median(returns$Luxury_diff.resid.gam, na.rm = T) # 518 days
